...
echo ""
echo -e "${YELLOW}VPS de 1 GB de RAM:${NC} si esta es la 2ª o 3ª instancia y"
echo -e "vas justo de memoria, ejecuta desde PND/: ${BOLD}bash optimizar-1gb.sh${NC}"
echo -e "(parchea esta instancia recién creada también)."
echo ""
